...
import DCwork.utils.WebGenerateUtils;

/**
 * @author Forrest
 *
 */
public class WebPreviewServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
      WebGenerateUtils.generateWeb(dcUser.getTemplateName(), dcUser.getResLoader());
    } catch (Exception e) {
      e.printStackTrace();
    }
		
		String targetUrl = String.format("../../%s/index.html", dcUser.getSiteName());
